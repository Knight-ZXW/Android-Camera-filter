...
public class ImageUtil extends FileUtil {
    ...
    public static void saveBitmap(Bitmap bmp, String filename) {
        ...
        LogUtil.info(LOG_TAG, "saving Bitmap : " + filename);
        ...
        try {
            ...
            LogUtil.error(LOG_TAG, "Err when saving bitmap...");
            e.printStackTrace();
            return;
        }

        LogUtil.info(LOG_TAG, "Bitmap " + filename + " saved!");
    }
    ...
    public static FaceRects findFaceByBitmap(Bitmap bmp, int maxFaces) {
        ...
        if(bmp == null) {
            LogUtil.error(LOG_TAG, "Invalid Bitmap for Face Detection!");
            return null;
        }
        ...
        try {
            ...
            LogUtil.error(LOG_TAG, "findFaceByBitmap error: " + e.getMessage());
            return null;
        }
