 ...
 */
public class ImageFilterBulgeDistortion extends CameraFilterBulgeDistortion {
    public ImageFilterBulgeDistortion(Context applicationContext) {
    ...
    protected int createProgram(Context applicationContext) {
        return GlUtil.createProgram(applicationContext, R.raw.vertex_shader,
                R.raw.fragment_shader_2d_bulge_distortion);
    }
}
