 ...
 */
public class CameraFilterPixelize extends CameraFilter {
    private int muiResolutionLocation;

    public CameraFilterPixelize(Context applicationContext) {
    ...
    protected int createProgram(Context applicationContext) {
        return GlUtil.createProgram(applicationContext, R.raw.vertex_shader,
                R.raw.fragment_shader_ext_pixelize);
    }
    ...
    protected void bindGLSLValues(float[] mvpMatrix, FloatBuffer vertexBuffer, int coordsPerVertex,
        ...
        float []resolution = new float[]{
                (float)mIncomingWidth, (float)mIncomingHeight, 1.0f};
