...
public class CameraFilterPinchDistortion extends CameraFilter {
    private final static String TAG = "CameraFilterPinchDistortion";
    ...
    public CameraFilterPinchDistortion(Context applicationContext) {
        this(applicationContext, 1.0f, 0.5f, new PointF(0.5f, 0.5f));
    }
    ...
    protected int createProgram(Context applicationContext) {
        return GlUtil.createProgram(applicationContext, R.raw.vertex_shader,
                R.raw.fragment_shader_ext_pinch_distortion);
    }
