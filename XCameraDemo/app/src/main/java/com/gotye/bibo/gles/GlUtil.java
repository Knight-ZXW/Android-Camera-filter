...
public class GlUtil {
    ...
    public static int loadShader(int shaderType, String source) {
        ...
        Log.d(TAG, "shader created: #" + shader);
    ...
    public static int createTexture(int textureTarget, Bitmap bitmap, boolean repeat) {
        return createTexture(textureTarget, bitmap, GLES20.GL_LINEAR, GLES20.GL_LINEAR,
                repeat ? GLES20.GL_REPEAT : GLES20.GL_CLAMP_TO_EDGE,
                repeat ? GLES20.GL_REPEAT : GLES20.GL_CLAMP_TO_EDGE);
    }

    public static int createTexture(int textureTarget, int type, ByteBuffer data,
        ...
        GLES20.glTexImage2D(textureTarget, 0,
                type/*GLES20.GL_LUMINANCE*/,
                width, height, 0, type/*GLES20.GL_LUMINANCE*/, GLES20.GL_UNSIGNED_BYTE,
                data);
    ...
    public static int createTextureWithTextContent(String text, int textsize) {
        ...
        int baseline = (128 - fontMetrics.bottom + fontMetrics.top) / 2 - fontMetrics.top;
        canvas.drawText(text, 128, baseline, textPaint);
