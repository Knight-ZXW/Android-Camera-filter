 ...
 */
public class CameraFilterGaussianSelectiveBlur implements IFilter {
    private IFilter mFilter;

    public CameraFilterGaussianSelectiveBlur(Context context) {
    ...
    public CameraFilterGaussianSelectiveBlur(Context context,
        ...
        mFilter = new ImageFilterTwoInput(context,
                new CameraFilterGaussianBlur(context, blurRadius),
