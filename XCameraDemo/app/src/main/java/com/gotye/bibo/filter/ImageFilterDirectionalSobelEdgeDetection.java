 ...
 */
class ImageFilterDirectionalSobelEdgeDetection extends CameraFilterDirectionalSobelEdgeDetection {

    public ImageFilterDirectionalSobelEdgeDetection(Context applicationContext) {
    ...
    protected int createProgram(Context applicationContext) {
        return GlUtil.createProgram(applicationContext, R.raw.vertex_shader_3x3_texture_sampling,
                R.raw.fragment_shader_2d_directional_sobel_edge_detection);
    }
}
