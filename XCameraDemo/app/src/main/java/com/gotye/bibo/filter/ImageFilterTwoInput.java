...
public class ImageFilterTwoInput extends ImageFilter {
    ...
    public ImageFilterTwoInput(Context context,
                               IFilter inputFilter1, IFilter inputFilter2,
    ...
    public void setTextureSize(int width, int height) {
        ...
        mOutputFilter.setTexture(
                mFrameBufferTextures[0], mFrameBufferTextures[1], -1);
    }
