...
void main() {
    ...
    blurCoordinates[0] = vTextureCoord.xy + singleStepOffset * vec2(-1.0, 1.0);
    blurCoordinates[1] = vTextureCoord.xy + singleStepOffset * vec2(0.0, 1.0);
    blurCoordinates[2] = vTextureCoord.xy + singleStepOffset * vec2(1.0, 1.0);
    blurCoordinates[3] = vTextureCoord.xy + singleStepOffset * vec2(-1.0, 0.0);
    blurCoordinates[4] = vTextureCoord.xy + singleStepOffset * vec2(1.0, 0.0);
    blurCoordinates[5] = vTextureCoord.xy + singleStepOffset * vec2(-1.0, -1.0);
    blurCoordinates[6] = vTextureCoord.xy + singleStepOffset * vec2(0.0, -1.0);
    blurCoordinates[7] = vTextureCoord.xy + singleStepOffset * vec2(1.0, -1.0);

    // 9 12 9
    // 12 15 12
    // 9 12 9
    float sampleColor = texture2D(uTexture, vTextureCoord).g * 15.0;
    sampleColor += texture2D(uTexture, blurCoordinates[0]).g * 9.0;
    sampleColor += texture2D(uTexture, blurCoordinates[1]).g * 12.0;
    sampleColor += texture2D(uTexture, blurCoordinates[2]).g * 9.0;
    sampleColor += texture2D(uTexture, blurCoordinates[3]).g * 12.0;
    sampleColor += texture2D(uTexture, blurCoordinates[4]).g * 12.0;
    sampleColor += texture2D(uTexture, blurCoordinates[5]).g * 9.0;
    sampleColor += texture2D(uTexture, blurCoordinates[6]).g * 12.0;
    sampleColor += texture2D(uTexture, blurCoordinates[7]).g * 9.0;

    sampleColor = sampleColor / 99.0;*/
